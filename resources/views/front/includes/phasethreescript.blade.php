    ...
    <script id="code">
        function init() {
            ...
            myDiagram.nodeTemplateMap.add("Blockchian",
                $(go.Node, "Table", nodeStyle(),
                    $(go.Panel, "Spot",
                        $(go.Shape, "Circle",
            ...
            myDiagram.nodeTemplateMap.add("Smart Contract",
                $(go.Node, "Table", nodeStyle(),
                    $(go.Panel, "Spot",
                        $(go.Shape, "Circle",
            ...
            // taken from https://unpkg.com/gojs@2.2.7/extensions/Figures.js:
                ...
                $(go.Palette, "myPaletteDiv",  // must name or refer to the DIV HTML element
                    {
                        ...
                        model: new go.GraphLinksModel([  // specify the contents of the Palette
                            { category: "Start", text: "Blockchian" },
                            { text: "Step" },
                            { category: "Conditional", text: "???" },
                            { category: "End", text: "Smart contract" },
