<?php $__env->startSection('content'); ?>
    <section class="content-header margin-50">
        ...
        <?php endif; ?>
<?php if(remaining_days()>0 && remaining_days()<16): ?>
        <div style="  width: 1em;height: 1em; '''position: fixed;''' '''top: 0em;'''top: 0em;left: 1em;"><?php echo tooltip_msg(remaining_days()." Days Remains","");?></div>
