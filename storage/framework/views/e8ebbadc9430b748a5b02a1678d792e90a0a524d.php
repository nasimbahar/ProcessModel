    ...
    <section class="content" style="min-height: 600px">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__("front.subheaderphasethree")); ?></h3>
            </div>
                    ...
                    <div id="allSampleContent" class="p-4 w-full">
                                    ...
                                    $(go.Palette, "myPaletteDiv",  // must name or refer to the DIV HTML element
                                        {
                                            ...
                                            model: new go.GraphLinksModel([  // specify the contents of the Palette
                                                { category: "Start", text: "Node" },
                                                { text: "Smart Contract" },
                                                { category: "Conditional", text: "???" },
                                                { category: "End", text: "participant " },
                        ...
                        <div id="sample">
                            <div style="width: 100%; display: flex; justify-content: space-between">
                                <div id="myPaletteDiv" style="padding-top:20px;width: 200px; margin-right: 2px; background-color: #282c34;"></div>
                                <div id="myDiagramDiv" style="flex-grow: 1; height: 750px; background-color: #282c34;"></div>
                            </div>
                            <textarea id="mySavedModel" style="width:10%;height:30px;visibility: hidden">

</textarea>
                            <button class="btn btn-info" onclick="printDiagram()">Print Diagram Using SVG</button>
                            <button class="btn btn-warning" ><?php echo e(__("front.gotofourthphase")); ?></button>
                        </div>
