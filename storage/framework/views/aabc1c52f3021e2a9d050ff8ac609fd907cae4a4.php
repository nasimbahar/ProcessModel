    ...
    <section class="content" style="min-height: 600px">
        ...
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title"><?php echo e(__("front.subheaderphaseone")); ?></h3>
            </div>
            <div class="box-body">
                ...
                <ul class="timeline">
                    ...
                    <li id="q1">
                        ...
                        <div class="timeline-item">
                            <h3 class="timeline-header"><?php echo e(__("front.q1")); ?></h3>
                            <div class="timeline-body" id="q1body">
                                <button class="btn btn-info" id="q1yes"><?php echo e(__("front.yes")); ?></button>
                                <button class="btn btn-danger" id="q1no"><?php echo e(__("front.no")); ?></button>
                            </div>
                    ...
                    <li style="display: none" id="q2" >
                        ...
                        <div class="timeline-item">
                            ...
                            <h3 class="timeline-header"><?php echo e(__("front.q2")); ?></h3>

                            <div class="timeline-body" id="q2body">

                                <button class="btn btn-info" id="q2yes"><?php echo e(__("front.yes")); ?></button>
                                <button class="btn btn-danger" id="q2no"><?php echo e(__("front.no")); ?></button>
                            </div>
                    ...
                    <li style="display: none" id="q3" >
                        ...
                        <div class="timeline-item">
                            ...
                            <h3 class="timeline-header"><?php echo e(__("front.q3")); ?></h3>

                            <div class="timeline-body" id="q3body">

                                <button class="btn btn-info" id="q3yes"><?php echo e(__("front.yes")); ?></button>
                                <button class="btn btn-danger" id="q3no"><?php echo e(__("front.no")); ?></button>
                            </div>
                    ...
                    <li style="display: none" id="q4" >
                        ...
                        <div class="timeline-item">
                            ...
                            <h3 class="timeline-header"><?php echo e(__("front.q4")); ?></h3>

                            <div class="timeline-body" id="q4body">

                                <button class="btn btn-info" id="q4yes"><?php echo e(__("front.yes")); ?></button>
                                <button class="btn btn-danger" id="q4no"><?php echo e(__("front.no")); ?></button>
                            </div>
                    ...
                    <li style="display: none" id="q5" >
                        ...
                        <div class="timeline-item">
                            ...
                            <h3 class="timeline-header"><?php echo e(__("front.q5")); ?></h3>

                            <div class="timeline-body" id="q5body">

                                <button class="btn btn-info" id="q5yes"><?php echo e(__("front.yes")); ?></button>
                                <button class="btn btn-danger" id="q5no"><?php echo e(__("front.no")); ?></button>
                            </div>
                    ...
                    <li style="display: none" id="q6" >
                        ...
                        <div class="timeline-item">
                            ...
                            <h3 class="timeline-header"><?php echo e(__("front.q6")); ?></h3>

                            <div class="timeline-body" id="q6body">

                                <button class="btn btn-info" id="q6yes"><?php echo e(__("front.yes")); ?></button>
                                <button class="btn btn-danger" id="q6no"><?php echo e(__("front.no")); ?></button>
                            </div>
...
<?php $__env->startSection("scripts"); ?>
    <script type="text/javascript">
        $(function () {
            var nohtml=' <a class="btn btn-danger btn-xs noneed" ><?php echo e(__("front.noneed")); ?></a>';
            ...
            var publicpermissionlesslabel='<div class="alert alert-success alert-dismissible">\n' +
                ...
                '<?php echo e(__("front.needpublicblockchian")); ?>.\n' +
                '</div>';
            var publicpermissionedlabel='<div class="alert alert-success alert-dismissible">\n' +
                '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>\n' +
                '<h4><i class="icon fa fa-check"></i> Alert!</h4>\n' +
                '<?php echo e(__("front.needpublicpermissionblockchian")); ?>.\n' +
                '</div>';
                var buttonphaswtwo=' <a class="btn btn-warning btn-lg noneed" href=<?php echo e(admin_url("processmodel/phasetwo")); ?> ><?php echo e(__("front.gotosecondphase")); ?></a>';
